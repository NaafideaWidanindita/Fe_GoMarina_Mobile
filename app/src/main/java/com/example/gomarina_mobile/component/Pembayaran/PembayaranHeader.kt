...
@Composable
fun PembayaranHeader(navController: NavHostController) {
    TopAppBar(
        title = { Text("Pembayaran", color = Color.Black) },
...
@Composable
fun PembayaranHeaderPreview() {
    GoMarina_MobileTheme {
        PembayaranHeader(navController = rememberNavController())
    }
}
